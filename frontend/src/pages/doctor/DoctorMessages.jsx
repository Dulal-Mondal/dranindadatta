            ...
            <div className="max-w-3xl mx-auto px-4 py-8">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-xl border border-gray-100">
                        ...
                        <p className="text-gray-400 text-sm mt-1">Conversations will appear when patients message you</p>
                    </div>
                ) : (
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm divide-y divide-gray-50">
                        {filtered.map((conv) => {
                            ...
                            return (
                                <div
                                    key={conv._id}
                                    onClick={() => navigate('/doctor/chat/' + other._id)}
                                    className="flex items-center gap-4 p-4 hover:bg-gray-50 cursor-pointer transition"
                                >
                                    <div className="relative shrink-0">
                                        <img
                                            src={other.avatar || 'https://ui-avatars.com/api/?name=' + other.name + '&background=6366f1&color=fff&size=80'}
                                            alt={other.name}
